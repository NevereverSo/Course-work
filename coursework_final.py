    ...
    if daily_weather_df.empty and cities_weather_df.empty and countries_weather_df.empty:
        ...
        with tab1:
            ...
            if not df_display.empty:
                ...
                # Отображение таблицы с исправленным параметром width
                st.dataframe(
                    df_filtered.iloc[start_idx:end_idx],
                    width='stretch',  # Исправлено с use_container_width=True
                    height=400
                )
        ...
        with tab2:
            ...
            if not daily_weather_df.empty:
                ...
                if chart_type == "Гистограмма":
                    ...
                    # Исправлено: замена use_container_width на width='stretch'
                    ...
                    if len(numeric_cols) > 1:
                        ...
                        if corr_pairs:
                            ...
                            st.dataframe(corr_df.sort_values('Корреляция', key=abs, ascending=False), width='stretch')
                        else:
        ...
        if not numeric_cols:
            ...
            if analysis_method == "Кластеризация":
                ...
                if len(features) >= 2:
                    ...
                    if 'Cluster' in df_viz.columns:
                        ...
                        st.dataframe(cluster_stats.style.background_gradient(cmap='coolwarm'), width='stretch')
            ...
            # ========== PCA ==========
                ...
                if len(pca_features) >= 2:
                    ...
                    st.dataframe(loadings.style.background_gradient(cmap='coolwarm', axis=0), width='stretch')
...
with footer_col1:
    st.caption("🌤️ Weather Analytics Dashboard • Версия 2.0")
with footer_col2:
    st.caption(f"Данные обновлены: {datetime.now().strftime('%Y-%m-%d')}")